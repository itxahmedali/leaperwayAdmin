...
export declare class NgxEditorComponent implements ControlValueAccessor, OnInit, OnDestroy, OnChanges {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NgxEditorComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NgxEditorComponent, "ngx-editor", never, { "placeholder": "placeholder"; "editable": "editable"; "outputFormat": "outputFormat"; "customMenuRef": "customMenuRef"; }, { "init": "init"; "focusOut": "focusOut"; "focusIn": "focusIn"; }, never, never>;
}
